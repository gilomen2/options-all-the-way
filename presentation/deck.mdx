...
<Image src='http://localhost:3000/images/options-list.png' style={{ width: '67%', backgroundSize: 'contain' }}></Image>
...
```jsx 2 13:44 file=./examples/App.js title="Set Up Our Menu"
```
